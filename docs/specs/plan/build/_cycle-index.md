...
| `91a175a4` | [kc-04-selectable-skill-prompt-layout](kc-04-selectable-skill-prompt-layout-91a175a4/plan.md) — XML-default + opt-in YAML skill-prompt layout (closes #78/D-TEST-0073 S3; F2=F2.b USER-DIVERGENT) | 4 | 2 (A+B) | pending | `in-flight` | TBD |
