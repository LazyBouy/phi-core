...
| `91a175a4` | [kc-04-selectable-skill-prompt-layout](kc-04-selectable-skill-prompt-layout-91a175a4/plan.md) — XML-default + opt-in YAML skill-prompt layout (#78/D-TEST-0073 S3 — primitive landed, **held open pending live YAML-config validation via #79**; F2=F2.b USER-DIVERGENT) | 4 | 2 (A+B) | A1·B1 (both PASS) | `audited-pending-retro` (gate-4 PASS; +6 tests → 589; clippy/fmt clean; #78 unit-validated, **NOT live-validated**) | pending |
